...
>> There is a 5/11 chance that Elvis was an identical twin. (See work)
...
>> While both Bayesian and Frequentists will make use of models to help form a conclusion, Bayesian statistics will also take into account relevant historical information when coming to the conclusion. Frequentists will adhere more strictly to only the model when coming to a conclusion.
